using ConcesionarioVehiculo.Enunm;
using ConcesionarioVehiculo.Interface;
using ConcesionarioVehiculo.Modelos;
using System;
    ...
    internal class Program
    {
        ...
        private static void ProcesarOpcion(int opcion)
        {
            switch (opcion)
            {
                ...
                case 6: Console.WriteLine("¡Gracias por usar el Sistema de Concesionario!"); break;
        ...
        {
            var auto1 = new Auto(siguienteId++, "Mazda", "CX-5", 2024, 28000, TipoCombustible.Gasolina, EstadoVehiculo.Nuevo, 4, true);
            var moto1 = new Motocicleta(siguienteId++, "Honda", "CBR500R", 2023, 12000, TipoCombustible.Gasolina, EstadoVehiculo.Nuevo, 500, true);
            var camion1 = new Camion(siguienteId++, "Mercedes", "Actros", 2022, 80000, TipoCombustible.Diesel, EstadoVehiculo.Nuevo, 18, 6);
